...
public class Security extends WebSecurityConfigurerAdapter {
    ...
    public AuthenticationSuccessHandler myAuthenticationSuccessHandler(){
      ...
      List<UserDetails> userDeta  	public PasswordEncoder passwordEncoder()
  	{
  		try {
  			...
  			return new example.security.DESPasswordEncoder(keyFactory.generateSecret(key));ilsList = new ArrayList<>();
